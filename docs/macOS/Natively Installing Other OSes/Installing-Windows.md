...
!!! Note
    ...
    For example, running Windows XP will not be possible with an 2019 Macbook Pro since the earliest version rollback would be macOS Catalina which only supports Windows 10. You would have to figure out a way to reverse-engineer AND backport drivers for Windows 7 and XP.
